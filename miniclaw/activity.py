...
class ActivityTracker:
    ...
    def snapshot(self, n: int = 5) -> ActivitySnapshot:
        ...
        return ActivitySnapshot(
            ...
            agent_recents=sorted(self._active_agents.values(), key=lambda e: e.finished or e.timestamp, reverse=True)[:n],
            tool_recents=sorted(self._active_tools.values(), key=lambda e: e.finished or e.timestamp, reverse=True)[:n],
