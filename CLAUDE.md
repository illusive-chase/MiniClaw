...
1. **Always enter plan mode** before making non-trivial changes. Explore the relevant code, draft your approach, and present the plan for approval before writing code.
2. **Clarify before committing.** If any requirement, scope, or design choice is ambiguous, ask me before finalizing your plan. Do not assume — surface the uncertainty.
3. **Read before editing.** Never modify a file you haven't read in this session. Understand existing patterns before proposing changes.
