...
from miniclaw2.channels.cli import CLIChannel
from miniclaw2.listeners.base import Listener

if TYPE_CHECKING:
    from miniclaw2.runtime import Runtime
    from miniclaw2.session import Session
...
class CLIListener(Listener):
    ...
    async def run(self, runtime: Runtime) -> None:
        ...
        console.print(Panel("MiniClaw v2", subtitle="type /help for commands", style="bold cyan"))
